...
const upload = () => {
    ...
    const handleAnalyze = async ({ companyName, jobTitle, jobDescription, file }: { companyName: string, jobTitle: string, jobDescription: string, file: File }) => {
        ...
        try {
            ...
            setStatusText('Analyzing... This can take up to 30-60 seconds.');
            ...
            if (!feedback) {
                setStatusText('Error: Analysis failed. Please retry in a moment.');
                return;
            }
            ...
            <section className="main-section">
                <div className='page-heading py-16'>
                    ...
                    {isProcessing ? (
                        <>
                            <h2>{statusText}</h2>
                            <img src="/images/resume-scan.gif" className='w-full' alt='scan-gif' />
                        </>

                    ) : (
                        <h2>{statusText.startsWith('Error:') ? statusText : 'Drop your resume for ATS score and improvement tips'}</h2>
